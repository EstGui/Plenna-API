...
var rate_repository_exports = {};
__export(rate_repository_exports, {
  createRate: () => createRate,
  deleteRateById: () => deleteRateById,
  findAllRates: () => findAllRates,
  findRateById: () => findRateById,
  findRatesByBook: () => findRatesByBook,
  updateRate: () => updateRate
});
module.exports = __toCommonJS(rate_repository_exports);
